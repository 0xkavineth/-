...
const menuItems = [
  ...
  { icon: FolderOpen, label: "ข้อมูลคดี", href: "/cases" },
  { icon: CheckSquare, label: "สถานะคดี", badge: "124", href: "/tasks" },
  { icon: Calendar, label: "ปฎิทิน", href: "/calendar" },
  { icon: BarChart3, label: "ผลสรุป", href: "/analytics" },
  { icon: Users, label: "ทนายความ", href: "/team" },
]
