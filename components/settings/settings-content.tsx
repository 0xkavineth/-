...
export function SettingsContent() {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-4xl">
      <Card className="p-6">
        <h3 className="font-semibold text-lg mb-6">ข้อมูล โปรไฟล์</h3>
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <Button variant="outline">เปลี่ยนรูป</Button>
          ...
          <Button className="bg-primary hover:bg-primary/90">บันทึก การเปลี่ยนแปลง</Button>
        </div>
      </Card>

      <Card className="p-6">
        <h3 className="font-semibold text-lg mb-6">การแจ้งเตือน</h3>
